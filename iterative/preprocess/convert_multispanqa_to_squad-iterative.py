...
--no-first-iteration \
--save-path allspan_squad-style-iterative_except-appear-order-no-1st-iter

python3 convert_multispanqa_to_squad-iterative.py \
--mode allspan \
--sep-token except \
--answer-order  random-order \
--seed 1 \
--no-first-iteration \
--save-path allspan_squad-style-iterative_except-random-order-seed1-no-1st-iter
...
--seed 2 \
--no-first-iteration \
--save-path allspan_squad-style-iterative_except-random-order-seed2-no-1st-iter
...
--sep-token except \
--answer-order  appear-order \
--end_with_question_mark \
--save-path allspan_squad-style-iterative_except-appear-order-q-ending
...
--sep-token "<unused0>" \
--answer-order  appear-order \
--save-path allspan_squad-style-iterative_special-tok-appear-order
...
--answer-order  random-order \
--seed 1 \
--save-path allspan_squad-style-iterative_special-tok-random-order-seed1
...
--answer-order  random-order \
--seed 1 \
--save-path allspan_squad-style-iterative_except-random-order-seed1
...
--answer-order  random-order \
--seed 2 \
--save-path allspan_squad-style-iterative_except-random-order-seed2
...
--answer-order  random-order \
--seed 3 \
--save-path allspan_squad-style-iterative_except-random-order-seed3
'''